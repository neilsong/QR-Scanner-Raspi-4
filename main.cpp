...
int main()
{
    ...
    // IMPORTANT - make sure to keep 16:9 aspect ratio - tested with Logitech USB webcam
    ...
    while(ch!=27){
        ...
        //capture, make sure to crop to square before feeding to zbar
        cv::Mat crop_img = image(cv::Range(0,480), cv::Range(80,560));
